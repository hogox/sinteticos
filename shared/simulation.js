...
import { composeStepReason, composePersonaResponse, summarizeRun, buildFindings, buildFollowUps, buildPredictedPoints, buildPredictiveNotes, buildNavigationScreens } from "./reporting.js";
...
export function simulateRun(task, persona, iteration, options) {
    const { uid, overrides = {}, svgOptions = {}, useChooseAction = true, engineLabel = "browser-simulated", sourceLabel = "client-local", executionNotes = "Fallback local sin backend ni Playwright.", timingMultiplier = 9500, completionStrategy = "client" } = options;
