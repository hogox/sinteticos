...
const VISION_MODEL = process.env.SINTETICOS_VISION_MODEL || "claude-haiku-4-5-20251001";
...
const ABSOLUTE_MAX_STEPS = Number(process.env.SINTETICOS_ABSOLUTE_MAX_STEPS || 10);
